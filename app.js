...
const BRANDS = ["Acne Studios","Adidas","Aimé Leon Dore","Alain Mikli","Alberta Ferretti","Alberto Biani","Alexander McQueen","Alice + Olivia","Ami","Amiri","Andrea Pfister","Ann Demeulemeester","Anna Sui","Anthropologie","A.P.C.","Arc'teryx","Balenciaga","Balmain","Barbour","Bape","Base London","Beams Plus","Beats","Bershka","Billionaire Boys Club","Billabong","Blend","Blumarine","Boiler Room","Bogner","Bompard","Bottega Veneta","Boucheron","Breguet","Brioni","Bstroy","Brunello Cucinelli","Bulgari","Burberry","Cactus Plant Flea Market","Calvin Klein","Canada Goose","Carhartt WIP","Cartier","Celine","Chanel","Chloé","Chrome Hearts","Corteiz","Costume National","Courrèges","Cortez","Cotton Citizen","Cruz","Daily Paper","Dsquared2","Dior","Dior Homme","DKNY","Dolce & Gabbana","Dolce & Gabbana","Double Rainbow","Dries Van Noten","Eddie Bauer","Egon Schiele","Elie Saab","Emporio Armani","Enfants Riches Déprimés","ERD","Escada","Essentials","Etro","Fendi","Fila","Filling Pieces","Fiorucci","Foamposite","Fred Perry","Furla","Futur","GCDS","GmbH","Golden Goose","Goldbergh","Golf Wang","Goodhood","Gosha Rubchinskiy","Gucci","Guess","H&M","Harris Wharf London","Helmut Lang","Hermès","Hoka","Hugo Boss","Iceberg","Isabel Marent","Isabel Marant","Ivy Park","J.Crew","Jacquemus","Jil Sander","Jimmy Choo","Jordan","Juicy Couture","JW Anderson","Kangol","Karl Lagerfeld","Kenzo","Kith","Karl Kani","Kiton","Ksubi","Kway","Lacoste","Lanvin","Lardini","Le Coq Sportif","Levi's","Lemaire","Loewe","Longchamp","Louis Vuitton","Loro Piana","Luciano Barbera","Luisa Beccaria","Lululemon","Mackage","Maison Kitsuné","Maison Margiela","Majestic Filatures","Mango","Manolo Blahnik","Marc Jacobs","Margaret Howell","Marine Serre","Markus Lupfer","Marni","Mastermind Japan","McQ Alexander McQueen","Miu Miu","Moncler","Moncler Grenoble","Moose Knuckles","Moschino","Mountain Hardwear","MSGM","Napapijri","Neil Barrett","New Balance","New Era","New Look","Nike","Noah","Norse Projects","North Face","Nudie Jeans","Number (N)ine","Oakley","Off-White","Olive Clothing","On Running","Opening Ceremony","Orlebar Brown","Oversize","Palm Angels","Patagonia","Paul Smith","Peak Performance","Polo Ralph Lauren","Prada","Pronounce","Puma","Purple","Raf Simons","Rag & Bone","Rains","Ralph Lauren","Ray-Ban","Reebok","Rejina Pyo","Rellik","Rick Owens","Roberto Cavalli","Rodarte","Rolex","Rouje","RTA","Sacai","Saint Laurent","Salomon","Samsonite","Sandro","Satisfyer","Schott NYC","Scotch & Soda","Sean John","Sergio Rossi","Sessun","Stone Island","Stussy","Suicoke","Supreme","Sweaty Betty","Takumi","Tasaki","Ted Baker","The Fader","The Kooples","The North Face","Thom Browne","Thom Krom","Tiffany & Co.","Timberland","Tod's","Tom Ford","Tommy Hilfiger","Tory Burch","True Religion","Twinset","Ugg","Under Armour","Uniqlo","Valentino","Van Cleef & Arpels","Vans","Versace","Victorinox","Vivienne Westwood","Vlone","Wandler","We11done","Woolrich","Wrangler","Y-3","Yeezy","Yohji Yamamoto","Zadig & Voltaire","Zara","Zegna"];
const CATEGORIES = [
